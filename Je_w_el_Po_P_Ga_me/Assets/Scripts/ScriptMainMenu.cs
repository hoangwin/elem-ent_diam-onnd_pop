...
public class ScriptMainMenu : MonoBehaviour {
    ...
    public GUISkin skinButtonHighScore;
	...
	void OnGUI()
    {
       ...
       * */
        ...
        GUI.skin = skinButtonNormal;
        if (GUI.Button(new Rect(Screen.width / 2 - 240 * DEF.scaleX, (360 + 1 * 140) * DEF.scaleY, 480 * DEF.scaleX, 140 * DEF.scaleY), "Classic"))
        {
			//soundBack.PlayOneShot();
